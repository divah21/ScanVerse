...
export function StatsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 rounded-full blur-3xl opacity-50 translate-x-1/2 -translate-y-1/2 stats-float-1" />
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-r from-cyan-600/20 to-indigo-600/20 rounded-full blur-3xl opacity-40 -translate-x-1/2 translate-y-1/2 stats-float-2" />

      {/* Floating particles */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="stats-particle absolute top-20 left-[15%] w-2 h-2 bg-blue-400/30 rounded-full"></div>
        <div className="stats-particle absolute top-40 left-[25%] w-1.5 h-1.5 bg-blue-400/30 rounded-full"></div>
        <div className="stats-particle absolute top-60 left-[75%] w-2 h-2 bg-cyan-400/30 rounded-full"></div>
        <div className="stats-particle absolute bottom-40 left-[20%] w-1.5 h-1.5 bg-cyan-400/30 rounded-full"></div>
      </div>
      ...
      <div className="absolute inset-0 opacity-[0.05]">
        <div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%236366f1' fill-opacity='1'%3E%3Cpath d='M20 20.5L20.5 20L20 19.5L19.5 20z'/%3E%3C/g%3E%3C/svg%3E")`,
          }}
        />
      </div>
