...
export function CallToActionSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-20 w-32 h-32 bg-blue-400/20 rounded-full blur-xl cta-float-1" />
      <div className="absolute top-40 right-32 w-24 h-24 bg-cyan-400/15 rounded-full blur-2xl cta-float-2" />
      <div className="absolute bottom-20 left-1/3 w-40 h-40 bg-indigo-400/15 rounded-full blur-3xl cta-float-3" />
      <div className="absolute bottom-40 right-20 w-28 h-28 bg-blue-400/20 rounded-full blur-xl cta-float-1" />

      {/* Floating particles */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="cta-particle absolute top-20 left-[10%] w-2 h-2 bg-blue-400/40 rounded-full"></div>
        <div className="cta-particle absolute top-40 left-[20%] w-1.5 h-1.5 bg-cyan-400/40 rounded-full"></div>
        <div className="cta-particle absolute top-60 left-[80%] w-2 h-2 bg-teal-400/40 rounded-full"></div>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              ...
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 via-cyan-200 to-teal-200">
                Digital Life?
              </span>
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              asChild
              size="lg"
              className="text-lg px-8 py-6 bg-white text-blue-900 hover:bg-gray-100 border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
              <Link href="/report">
